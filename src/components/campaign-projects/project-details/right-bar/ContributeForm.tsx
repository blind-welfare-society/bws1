    ...
    return (
        ...
        <div className="form-group row">
            <div className="col-md-12">
                <input type="text" id="full_name"  {...register("full_name")} placeholder="Full Name" className="form-control" />
                <p className="form_error">{errors.full_name?.message}</p>
            </div>
            <div className="col-md-12">
                <input type="email" id="email"  {...register("email")} placeholder="Email" className="form-control" />
                <p className="form_error">{errors.email?.message}</p>      
            </div>
            <div className="col-md-12">      
                <input type="tel" id="phone"  {...register("phone")} placeholder="Phone Number" className="form-control" />
