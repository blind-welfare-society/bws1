                    ...
                    <div className="col-12">
                        <div className="donation-sec">
                            ...
                            <p><strong>Date of Donation:</strong> {formattedDate}</p>
                               ...
                               {currentPath.includes('sponsormeal') ? (
                                    <a href={`http://localhost/bws-admin/download-sponsor-pdf/${donationData.id}`} className="donation_button" download="">Download your Receipt</a>
                                ) : (
                                  <a href={`http://localhost/bws-admin/exportDonationPDF/${donationData.id}`} className="donation_button" download="">Download your Receipt</a>
                                )}
                        </div>
                    </div>
                </div>   
