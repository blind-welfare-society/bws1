...
const footer_data: DataType[] = [
   ...
   },
   {
      ...
      page:"home_2",
      widget_title: "Quick links",
      footer_link: [{ link: "#", link_title: "Contact" }, { link: "/terms-conditions", link_title: "Terms & Conditions" }, { link: "/privacy-policy", link_title: "Privacy Policy" }, { link: "/donation-refund-policy", link_title: "Donation Refund Policy" }]
   },
]
